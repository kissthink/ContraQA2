...
for i in range(10):
    ...
    df_dev = pd.read_csv("fixed_data/boolean{}_test.csv".format(i))
...
# In[5]:
    ...
    output_model_file = os.path.join("models", name + "_pytorch_model.bin")
    ...
    # load eval
    eval_examples = processor.get_dev_examples(df_dev)
    ...
    output_eval_file = os.path.join("outputs", name + "_eval_results.txt")
